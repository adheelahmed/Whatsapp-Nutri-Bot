...
const job = schedule.scheduleJob('7 12 * * *' /* change the value sec(*)  min(*) hour(*) d o m(*) month(*) d o w(*)  */ , async function(){
...
const job2 = schedule.scheduleJob('47 * * * *' /* change the value sec(*)  min(*) hour(*) d o m(*) month(*) d o w(*)  */ , async function(){
